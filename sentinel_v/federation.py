...
class FederatedDefenseNode:
    ...
    def share_iocs_batch(self, iocs: List[Dict[str, Any]]) -> int:
        ...
        Args:
            iocs: List of IoC dictionaries with keys: ioc_type, value,
    ...
    def receive_ioc(self, ioc: Dict[str, Any]) -> bool:
        ...
        Args:
            ioc: IoC dictionary with keys: ioc_type, value, description,
                confidence, origin_node
    ...
    def get_received_iocs(self) -> List[Dict[str, Any]]:
        ...
        """
        return [
            ioc for ioc in self.local_iocs if ioc.get("origin_node") != self.node_id
        ]
